...
|----------	|-------	|--------	|
| Choose a project | *Chosing* or *Chosen* | *Link to project* |
| Choose an issue | Issue *chosen* / *choosing* | *https://github.com/italanta/elewa-group/issues/13* |
...
- [1] Take part in the project kick off
- [2] Develop my portfolio page
- [3] Register myself onto the workroom
- [4] Install *< Elewa or Kujali >* on my local device
- [5] Connect *< Elewa or Kujali >* to my local emulators and run the project
- [6] Connect *< Elewa or Kujali >* to firebase
